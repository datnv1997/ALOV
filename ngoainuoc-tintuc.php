...
<body>
    ...
    <section id="content">
        <div class="container">
            <div class="row mt-3">
                <div class="col-md-9 news-ngoainuoc">
                    <div class="row chau-au">
                        <div class="btn btn-danger">
                            Kiều bào Châu Âu
                        </div>
                        <hr>
                        <div class="row mt-3 header">
                            <img src="assets/img/img_snow.jpg" alt="" class="col-md-7 w-100 h-75">
                            <div class="col-md-5">
                                <h3><a href="">Đồng bào Châu Âu nhớ về tổ quốc</a></h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt earum labore iste
                                    quos sapiente rerum accusamus et perspiciatis ipsum sed.</p>
                            </div>
                        </div>
                        <div class="row mt-3 tintuc-phu">
                            <img src="assets/img/img_snow.jpg" alt="" class="col-md-5 w-100 h-75">
                            <div class="col-md-7">
                                <h3><a href="">Đồng bào Châu Âu nhớ về tổ quốc</a></h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt earum labore iste
                                    quos sapiente rerum accusamus et perspiciatis ipsum sed.</p>
...
<footer class="bg-danger text-white mt-2">
    <div class="container ">
        <div class="row pt-2">
